# Reel run trace — `reel_ef503873`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_ef503873`
...
```json
{
  "concept": "Mirror selfie outfit check showcasing embroidered lawn suit with confident Hinglish commentary",
  ...
  "scenes": [
    {
      ...
      "method": "lipsync",
      "mode": "scene",
      "visual": "confident young woman in embroidered green lawn suit standing in front of large mirror, holding phone up for mirror selfie, head-to-toe view in modern bedroom",
      "background": "modern minimalist bedroom with large full-length mirror, soft natural lighting from window, cream walls",
      "motion": "slow push-in",
      "energy": "",
      "transitionIn": "cut",
      "durationSec": 5.0,
      ...
      "vo": "Guys, today ka outfit check - yeh lawn suit dekho!"
    },
    {
      "n": 2,
      "goal": "showcase",
      "method": "lipsync",
      "mode": "scene",
      "visual": "same woman turning to three-quarter angle in mirror, still holding phone, showing the drape and flow of the embroidered suit",
      "background": "same modern bedroom with mirror, warm afternoon light, neutral tones",
      ...
      "vo": "Is embroidered lawn ka quality dekho - bilkul premium lagta hai!"
    },
    {
      "n": 3,
      "goal": "detail",
      "method": "lipsync",
      "mode": "scene",
      "visual": "closer waist-up shot of the same woman in mirror, phone still raised, focusing on intricate embroidery details and neckline",
      "background": "mirror reflection with soft bedroom lighting, blurred background depth",
      "motion": "slow zoom in",
      "energy": "",
      "transitionIn": "fade",
      "durationSec": 6.0,
      ...
      "vo": "Yeh embroidery work kitni detailed hai - obsessed with this design!"
    },
    {
      "n": 4,
      "goal": "wear",
      "method": "lipsync",
      "mode": "scene",
      "visual": "same woman adjusting dupatta gracefully while looking in mirror, phone in hand, showing complete styling",
      "background": "bedroom mirror setting with golden hour lighting streaming in",
      "motion": "gentle tilt right",
      ...
      "vo": "Perfect summer outfit - comfortable aur stylish dono!"
    },
    {
      "n": 5,
      "goal": "cta",
      "method": "lipsync",
      "mode": "scene",
      "visual": "confident close-up of woman looking directly at camera through mirror, phone raised, bright smile",
      "background": "mirror with soft bokeh bedroom background, bright natural lighting on face",
      ...
      "vo": "The Collection se shop karo - link bio mein hai, go check it out!"
    }
  ],
  "badges": [],
  "notes": "Mirror selfie outfit check following authentic social media format - same confident woman throughout all scenes with phone raised, showcasing embroidered lawn suit with casual Hinglish commentary building to shopping CTA"
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": true
}
...
```json
{
  "vo_text": "Guys, today ka outfit check - yeh lawn suit dekho!",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/audio/scene_1.mp3",
  "measured_duration": 5.0,
  "planned_duration": 5.0
}
```

### Scene 2 — showcase / lipsync / mode=scene / engine=video
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7597,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: same woman turning to three-quarter angle in mirror, still holding phone, showing the drape and flow of the embroidered suit. Setting: same modern bedroom with mirror, warm afternoon light, neutral tones. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
    "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/product_1.jpg"
  ],
  "shows_person": true
}
```
...
```json
{
  "vo_text": "Is embroidered lawn ka quality dekho - bilkul premium lagta hai!",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/audio/scene_2.mp3",
  "measured_duration": 6.0,
  "planned_duration": 6.0
}
```

### Scene 3 — detail / lipsync / mode=scene / engine=video
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7598,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: closer waist-up shot of the same woman in mirror, phone still raised, focusing on intricate embroidery details and neckline. Setting: mirror reflection with soft bedroom lighting, blurred background depth. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "vo_text": "Yeh embroidery work kitni detailed hai - obsessed with this design!",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/audio/scene_3.mp3",
  "measured_duration": 6.0,
  "planned_duration": 6.0
}
```

### Scene 4 — wear / lipsync / mode=scene / engine=video
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7599,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: same woman adjusting dupatta gracefully while looking in mirror, phone in hand, showing complete styling. Setting: bedroom mirror setting with golden hour lighting streaming in. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "vo_text": "Perfect summer outfit - comfortable aur stylish dono!",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/audio/scene_4.mp3",
  "measured_duration": 5.0,
  "planned_duration": 5.0
}
```

### Scene 5 — cta / lipsync / mode=scene / engine=video
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7600,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: confident close-up of woman looking directly at camera through mirror, phone raised, bright smile. Setting: mirror with soft bokeh bedroom background, bright natural lighting on face. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "vo_text": "The Collection se shop karo - link bio mein hai, go check it out!",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/audio/scene_5.mp3",
...
```json
{
  ...
  "transition_fallbacks": [
    ...
    "scene 5: 'zoom' not implemented -> fade"
  ],
  ...
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_ef503873/reel_ef503873_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_ef503873_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_ef503873_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_ef503873_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_ef503873_s3.png",
    "https://staging-storage.runkarobar.com/images/reel_ef503873_s4.png",
    "https://staging-storage.runkarobar.com/images/reel_ef503873_s5.png"
  ],
  "log": "NOT PERSISTED"
}
```
