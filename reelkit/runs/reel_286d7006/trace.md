# Reel run trace — `reel_286d7006`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_286d7006`
...
```json
{
  "concept": "Premium embroidered elegance meets modern sophistication",
  ...
  "scenes": [
    {
      ...
      "method": "edit_animate",
      "mode": "product",
      "visual": "Full elegant reveal of the emerald green embroidered lawn suit with intricate silver threadwork",
      "background": "soft cream marble surface with warm golden hour light streaming from above, subtle shadows creating depth",
      "motion": "slow push-in with gentle tilt",
      ...
      "vo": "Jab elegance aur tradition ka milna ho... The Collection ka premium embroidered lawn"
    },
    {
      "n": 2,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Extreme close-up of the intricate silver embroidery patterns and delicate threadwork on the neckline",
      "background": "pristine white silk draped surface with soft studio lighting, creating gentle highlights on metallic threads",
      "motion": "subtle orbit around the detail",
      ...
      "vo": "Har thread mein craftmanship ka jaadu... handpicked detailing"
    },
    {
      "n": 3,
      "goal": "wear",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Model gracefully wearing the complete suit ensemble, showcasing the flowing silhouette and coordinated dupatta",
      "background": "luxurious textured wall with warm ambient lighting, creating an upscale boutique atmosphere",
      ...
      "vo": "Premium lawn ka comfort... designer embroidery ka charm... ye hai true luxury"
    },
    {
      "n": 4,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Elegant flat lay of the complete three-piece suit with dupatta artfully arranged",
      "background": "polished dark wood surface with soft overhead lighting and subtle reflections",
      ...
      "vo": "The Collection... apna style statement banao"
    }
  ],
  "badges": [],
  "notes": "Aspirational showcase highlighting the premium embroidered lawn suit's craftsmanship and elegance. Clean framing progression from reveal to intricate detail to lifestyle wear, finishing with an artful product display. Warm Hinglish voiceover emphasizes luxury and tradition without making unsubstantiated claims."
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": false
}
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "slow push-in with gentle tilt",
  "energy_prompt_verbatim": "golden light rays",
  "full_prompt_sent": "slow push-in with gentle tilt. Full elegant reveal of the emerald green embroidered lawn suit with intricate silver threadwork. golden light rays.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/scene_1.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.2,
...
```json
{
  "vo_text": "Jab elegance aur tradition ka milna ho... The Collection ka premium embroidered lawn",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 4015,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: pristine white silk draped surface with soft studio lighting, creating gentle highlights on metallic threads. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "subtle orbit around the detail",
  "energy_prompt_verbatim": "shimmer effect",
  "full_prompt_sent": "subtle orbit around the detail. Extreme close-up of the intricate silver embroidery patterns and delicate threadwork on the neckline. shimmer effect.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/scene_2.png",
  "requested_duration": 5.004,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.3,
...
```json
{
  "vo_text": "Har thread mein craftmanship ka jaadu... handpicked detailing",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/audio/scene_2.mp3",
  "measured_duration": 5.004,
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 4016,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: luxurious textured wall with warm ambient lighting, creating an upscale boutique atmosphere. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "full_prompt_sent": "gentle crane down. Model gracefully wearing the complete suit ensemble, showcasing the flowing silhouette and coordinated dupatta.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/scene_3.png",
  "requested_duration": 6.128,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/clip_3.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.15,
    "end": 1.12,
...
```json
{
  "vo_text": "Premium lawn ka comfort... designer embroidery ka charm... ye hai true luxury",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/audio/scene_3.mp3",
  "measured_duration": 6.128,
  "planned_duration": 6.0
}
```
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 4017,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: polished dark wood surface with soft overhead lighting and subtle reflections. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "energy_prompt_verbatim": "soft glow",
  "full_prompt_sent": "slow pull-back. Elegant flat lay of the complete three-piece suit with dupatta artfully arranged. soft glow.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/scene_4.png",
  "requested_duration": 3.176,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/clip_4.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.2,
    "end": 1.0,
...
```json
{
  "vo_text": "The Collection... apna style statement banao",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/audio/scene_4.mp3",
  "measured_duration": 3.176,
...
```json
{
  "per_scene": [
    ...
    {
      "scene": 2,
      "fitted_duration": 5.004,
      "transition_in": "cut",
      "dipped_through_black": false
    },
    {
      "scene": 3,
      "fitted_duration": 6.128,
      "transition_in": "whip",
      "dipped_through_black": true
    },
    {
      "scene": 4,
      "fitted_duration": 3.176,
      "transition_in": "fade",
      "dipped_through_black": true
    }
  ],
  ...
  "total_duration": 20.17,
  "master_resolution": "1080x1920",
  "captions_burned": false,
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_286d7006/reel_286d7006_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_286d7006_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_286d7006_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_286d7006_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_286d7006_s3.png",
    "https://staging-storage.runkarobar.com/images/reel_286d7006_s4.png"
  ],
  "log": "NOT PERSISTED"
}
```
