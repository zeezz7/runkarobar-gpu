# Reel run trace — `reel_2ecb861f`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_2ecb861f`
...
```json
{
  ...
  "brief": "Reel for this embroidered lawn suit, warm female Hinglish",
  "config": {
    "lengthSec": 15,
    "resolution": "1080p",
    "aspectRatio": "9:16",
...
Follow these unless the brief says otherwise:
  - aim for about 3 scenes (stay within 2-4)
...
```json
{
  "concept": "Elegant embroidered lawn suit showcasing intricate craftsmanship",
  ...
  "scenes": [
    {
      ...
      "method": "edit_animate",
      "mode": "product",
      "visual": "Full shot of the emerald green embroidered lawn suit with intricate white floral patterns and detailed neckline",
      "background": "soft cream marble surface with warm golden hour lighting, gentle shadows, luxurious texture with subtle depth",
      "motion": "slow push-in",
      "energy": "",
      "transitionIn": "cut",
      "durationSec": 5.0,
      ...
      "vo": "Yeh hai real elegance - handcrafted embroidery ke saath"
    },
    {
      "n": 2,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Close-up macro shot of the intricate white embroidered floral motifs and paisley patterns on the emerald fabric",
      "background": "soft textured linen surface with diffused natural light creating gentle highlights on embroidery threads",
      "motion": "gentle orbit",
      ...
      "vo": "Har thread mein craft ka passion"
    },
    {
      "n": 3,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Styled shot showing the complete embroidered lawn suit with dupatta draped elegantly",
      "background": "warm wooden surface with soft morning light, blurred botanical elements in background",
      ...
      "vo": "The Collection se - apna style statement banao today"
    }
  ],
  "badges": [],
  "notes": "Premium showcase focusing on the intricate embroidery craftsmanship with varied framing - full suit hero shot, detailed macro of embroidery work, and elegant styled presentation. Warm Hinglish voice celebrates the handcrafted artistry while maintaining aspirational tone."
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": false
}
...
```json
{
  ...
  "full_prompt_sent": "slow push-in. Full shot of the emerald green embroidered lawn suit with intricate white floral patterns and detailed neckline.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/scene_1.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.15,
...
```json
{
  "vo_text": "Yeh hai real elegance - handcrafted embroidery ke saath",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7752,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: soft textured linen surface with diffused natural light creating gentle highlights on embroidery threads. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "full_prompt_sent": "gentle orbit. Close-up macro shot of the intricate white embroidered floral motifs and paisley patterns on the emerald fabric. subtle shimmer.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/scene_2.png",
  "requested_duration": 4.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.25,
...
```json
{
  "vo_text": "Har thread mein craft ka passion",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/audio/scene_2.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7753,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: warm wooden surface with soft morning light, blurred botanical elements in background. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "energy_prompt_verbatim": "",
  "full_prompt_sent": "slow tilt down. Styled shot showing the complete embroidered lawn suit with dupatta draped elegantly.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/scene_3.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/clip_3.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.2,
    "end": 1.12,
...
```json
{
  "vo_text": "The Collection se - apna style statement banao today",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/audio/scene_3.mp3",
...
```json
{
  ...
  "total_duration": 14.91,
  "master_resolution": "1080x1920",
  "captions_burned": false,
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_2ecb861f/reel_2ecb861f_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_2ecb861f_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_2ecb861f_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_2ecb861f_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_2ecb861f_s3.png"
  ],
  "log": "NOT PERSISTED"
}
```
