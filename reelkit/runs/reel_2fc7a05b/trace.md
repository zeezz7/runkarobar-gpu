# Reel run trace — `reel_2fc7a05b`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_2fc7a05b`
...
```json
{
  "concept": "First-person mirror outfit check showcasing embroidered lawn suit details",
  ...
  "scenes": [
    {
      ...
      "method": "edit_animate",
      "mode": "product",
      "visual": "Woman in full-length mirror holding phone up, wearing the embroidered green lawn suit, full head-to-toe view in modern bedroom",
      "background": "Elegant modern bedroom with large mirror, warm natural light streaming through windows, minimalist decor",
      "motion": "slow push-in",
      "energy": "soft golden hour glow",
      "transitionIn": "cut",
      "durationSec": 5.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "Yaar this embroidered lawn suit is absolutely gorgeous"
    },
    {
      "n": 2,
      "goal": "showcase",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Same woman turning to three-quarter angle in mirror, phone still raised, showing the side silhouette and drape of the suit",
      "background": "Same elegant bedroom mirror setup, soft diffused lighting from the side",
      ...
      "vo": "Dekho na the drape aur fit kitna perfect hai"
    },
    {
      "n": 3,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Closer waist-up shot of woman in mirror focusing on the intricate embroidery work and neckline details, phone visible",
      "background": "Close-up mirror reflection with warm bedroom lighting highlighting fabric texture",
      "motion": "slow tilt down",
      "energy": "subtle fabric shimmer",
      "transitionIn": "zoom",
      "durationSec": 6.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "Embroidery work dekho kitna detailed aur beautiful hai yaar"
    },
    {
      "n": 4,
      "goal": "wear",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Woman looking directly at camera through mirror with confident smile, phone held up, full outfit visible with dupatta",
      "background": "Mirror reflection with soft bedroom ambiance, golden hour lighting",
      ...
      "vo": "Main toh completely obsessed hun with this whole look"
    },
    {
      "n": 5,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Final confident pose in mirror, woman adjusting dupatta with one hand while holding phone, complete outfit showcase",
      "background": "Bright modern bedroom mirror with perfect lighting showcasing the entire ensemble",
      "motion": "crane down",
      ...
      "vo": "Tumhe bhi pasand aaya toh The Collection se shop karo abhi"
    }
  ],
  "badges": [],
  "notes": "Authentic outfit check format with same woman throughout, showcasing the embroidered lawn suit from multiple angles in a natural mirror selfie style. Each scene builds the story from full reveal to detailed embroidery work to confident final pose with clear CTA."
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": true
}
...
```json
{
  ...
  "energy_prompt_verbatim": "soft golden hour glow",
  "full_prompt_sent": "slow push-in. Woman in full-length mirror holding phone up, wearing the embroidered green lawn suit, full head-to-toe view in modern bedroom. soft golden hour glow.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_1.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.15,
...
```json
{
  "vo_text": "Yaar this embroidered lawn suit is absolutely gorgeous",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 1190,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Same woman turning to three-quarter angle in mirror, phone still raised, showing the side silhouette and drape of the suit. Setting: Same elegant bedroom mirror setup, soft diffused lighting from the side. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
    "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/product_1.jpg"
  ],
  "shows_person": true
}
```
...
```json
{
  ...
  "full_prompt_sent": "gentle orbit right. Same woman turning to three-quarter angle in mirror, phone still raised, showing the side silhouette and drape of the suit.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_2.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.2,
...
```json
{
  "vo_text": "Dekho na the drape aur fit kitna perfect hai",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/audio/scene_2.mp3",
  "measured_duration": 5.0,
  "planned_duration": 5.0
}
```
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "slow tilt down",
  "energy_prompt_verbatim": "subtle fabric shimmer",
  "full_prompt_sent": "slow tilt down. Closer waist-up shot of woman in mirror focusing on the intricate embroidery work and neckline details, phone visible. subtle fabric shimmer.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_3.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/clip_3.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.25,
...
```json
{
  "vo_text": "Embroidery work dekho kitna detailed aur beautiful hai yaar",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/audio/scene_3.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 1192,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Woman looking directly at camera through mirror with confident smile, phone held up, full outfit visible with dupatta. Setting: Mirror reflection with soft bedroom ambiance, golden hour lighting. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "slight push-in",
  "energy_prompt_verbatim": "confident glow",
  "full_prompt_sent": "slight push-in. Woman looking directly at camera through mirror with confident smile, phone held up, full outfit visible with dupatta. confident glow.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_4.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/clip_4.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.18,
...
```json
{
  "vo_text": "Main toh completely obsessed hun with this whole look",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/audio/scene_4.mp3",
  "measured_duration": 6.0,
  "planned_duration": 6.0
}
```
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 1193,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Final confident pose in mirror, woman adjusting dupatta with one hand while holding phone, complete outfit showcase. Setting: Bright modern bedroom mirror with perfect lighting showcasing the entire ensemble. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  ...
  "energy_prompt_verbatim": "sparkle effect",
  "full_prompt_sent": "crane down. Final confident pose in mirror, woman adjusting dupatta with one hand while holding phone, complete outfit showcase. sparkle effect.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/scene_5.png",
  "requested_duration": 8.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/clip_5.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.2,
    "end": 1.0,
...
```json
{
  "vo_text": "Tumhe bhi pasand aaya toh The Collection se shop karo abhi",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/audio/scene_5.mp3",
...
```json
{
  ...
  "total_duration": 29.86,
  "master_resolution": "1080x1920",
  "captions_burned": false,
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_2fc7a05b/reel_2fc7a05b_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_2fc7a05b_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_2fc7a05b_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_2fc7a05b_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_2fc7a05b_s3.png",
    "https://staging-storage.runkarobar.com/images/reel_2fc7a05b_s4.png",
    "https://staging-storage.runkarobar.com/images/reel_2fc7a05b_s5.png"
  ],
  "log": "NOT PERSISTED"
}
```
