# Reel run trace — `reel_fd743109`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_fd743109`
...
```json
{
  ...
  "brief": "Outfit check reel for this embroidered lawn suit, warm female Hinglish",
  "config": {
    "lengthSec": 30,
    "resolution": "1080p",
    "aspectRatio": "9:16",
...
```json
{
  "concept": "Confident mirror selfie outfit check showcasing embroidered lawn suit",
  ...
  "scenes": [
    {
      ...
      "method": "edit_animate",
      "mode": "product",
      "visual": "Young woman in embroidered green lawn suit standing confidently in front of full-length mirror, holding phone up to take mirror selfie, full body shot showing complete outfit",
      "background": "Modern bedroom with large floor mirror, soft natural light from window, minimalist decor, warm morning ambiance",
      "motion": "slow push-in",
      "energy": "",
      "transitionIn": "cut",
      "durationSec": 6.0,
      ...
      "vo": "Yaar dekho yeh embroidered suit kitna gorgeous hai"
    },
    {
      "n": 2,
      "goal": "showcase",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Same woman turns to three-quarter angle still holding phone, showing the drape and flow of the embroidered lawn fabric, confident pose",
      "background": "Same modern bedroom setting with soft natural light, mirror reflecting the outfit beautifully",
      ...
      "vo": "Iska fabric itna soft aur comfortable hai"
    },
    {
      "n": 3,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Closer waist-up shot of the same woman still holding phone, focusing on the intricate embroidery work and neckline details of the green suit",
      "background": "Soft-focus mirror reflection with warm natural lighting highlighting fabric texture",
      "motion": "slow tilt up",
      "energy": "",
      "transitionIn": "zoom",
      "durationSec": 6.0,
      ...
      "vo": "Look at this embroidery work - bilkul stunning lagta hai"
    },
    {
      "n": 4,
      "goal": "wear",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Woman looking directly at camera through mirror with confident smile, still holding phone, showing complete styled look with the embroidered lawn suit",
      "background": "Bright modern room with mirror, natural lighting creating perfect selfie ambiance",
      "motion": "subtle zoom out",
      "energy": "warm glow",
      "transitionIn": "fade",
      "durationSec": 5.0,
      "motionEngine": "video",
      ...
      "vo": "Main totally obsessed hun is outfit se"
    },
    {
      "n": 5,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Final confident pose of woman in embroidered suit holding phone up, direct eye contact with camera, full styling visible",
      "background": "Clean modern mirror setting with perfect lighting for outfit showcase",
      "motion": "slow push-in",
      "energy": "",
      "transitionIn": "cut",
      "durationSec": 8.0,
      ...
      "vo": "Tumko bhi chahiye toh The Collection pe jaake shop karo abhi"
    }
  ],
  "badges": [],
  "notes": "Mirror selfie outfit check format with single confident woman showcasing embroidered lawn suit throughout, building from full reveal to detail shots ending with strong CTA, maintaining phone-up pose for authentic mirror selfie aesthetic"
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": true
}
...
```json
{
  ...
  "full_prompt_sent": "slow push-in. Young woman in embroidered green lawn suit standing confidently in front of full-length mirror, holding phone up to take mirror selfie, full body shot showing complete outfit.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_1.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.15,
...
```json
{
  "vo_text": "Yaar dekho yeh embroidered suit kitna gorgeous hai",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8270,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Same woman turns to three-quarter angle still holding phone, showing the drape and flow of the embroidered lawn fabric, confident pose. Setting: Same modern bedroom setting with soft natural light, mirror reflecting the outfit beautifully. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
    "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/product_1.jpg"
  ],
  "shows_person": true
}
```
...
```json
{
  ...
  "full_prompt_sent": "gentle orbit right. Same woman turns to three-quarter angle still holding phone, showing the drape and flow of the embroidered lawn fabric, confident pose. subtle shimmer.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_2.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.12,
...
```json
{
  "vo_text": "Iska fabric itna soft aur comfortable hai",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/audio/scene_2.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8271,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Closer waist-up shot of the same woman still holding phone, focusing on the intricate embroidery work and neckline details of the green suit. Setting: Soft-focus mirror reflection with warm natural lighting highlighting fabric texture. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  ...
  "energy_prompt_verbatim": "",
  "full_prompt_sent": "slow tilt up. Closer waist-up shot of the same woman still holding phone, focusing on the intricate embroidery work and neckline details of the green suit.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_3.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/clip_3.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.2,
    "end": 1.35,
...
```json
{
  "vo_text": "Look at this embroidery work - bilkul stunning lagta hai",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/audio/scene_3.mp3",
  "measured_duration": 6.0,
  "planned_duration": 6.0
}
```
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8272,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Woman looking directly at camera through mirror with confident smile, still holding phone, showing complete styled look with the embroidered lawn suit. Setting: Bright modern room with mirror, natural lighting creating perfect selfie ambiance. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "subtle zoom out",
  "energy_prompt_verbatim": "warm glow",
  "full_prompt_sent": "subtle zoom out. Woman looking directly at camera through mirror with confident smile, still holding phone, showing complete styled look with the embroidered lawn suit. warm glow.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_4.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/clip_4.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.2,
    "end": 1.0,
...
```json
{
  "vo_text": "Main totally obsessed hun is outfit se",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/audio/scene_4.mp3",
  "measured_duration": 5.0,
  "planned_duration": 5.0
}
```
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8273,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Final confident pose of woman in embroidered suit holding phone up, direct eye contact with camera, full styling visible. Setting: Clean modern mirror setting with perfect lighting for outfit showcase. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  ...
  "motion_prompt_verbatim": "slow push-in",
  "energy_prompt_verbatim": "",
  "full_prompt_sent": "slow push-in. Final confident pose of woman in embroidered suit holding phone up, direct eye contact with camera, full styling visible.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/scene_5.png",
  "requested_duration": 8.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/clip_5.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.25,
...
```json
{
  "vo_text": "Tumko bhi chahiye toh The Collection pe jaake shop karo abhi",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/audio/scene_5.mp3",
...
```json
{
  ...
  "total_duration": 29.92,
  "master_resolution": "1080x1920",
  "captions_burned": false,
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_fd743109/reel_fd743109_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_fd743109_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_fd743109_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_fd743109_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_fd743109_s3.png",
    "https://staging-storage.runkarobar.com/images/reel_fd743109_s4.png",
    "https://staging-storage.runkarobar.com/images/reel_fd743109_s5.png"
  ],
  "log": "NOT PERSISTED"
}
```
