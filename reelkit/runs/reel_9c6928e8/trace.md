# Reel run trace — `reel_9c6928e8`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_9c6928e8`
...
```json
{
  "concept": "Confident mirror selfie outfit check showcasing premium embroidered lawn suit",
  "voice": "female confident warm hinglish",
  "scenes": [
    {
      "n": 1,
      "goal": "reveal",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Full-length mirror shot of confident woman holding phone up, wearing complete embroidered green lawn suit, head-to-toe view in modern room",
      "background": "Large wall mirror in tastefully styled modern bedroom, soft natural light streaming from window, warm neutral tones, blurred elegant decor",
      "motion": "slow push-in",
      ...
      "vo": "Guys, main bilkul obsessed hun is outfit ke saath"
    },
    {
      "n": 2,
      "goal": "showcase",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Same woman turns to flattering three-quarter angle in mirror, showing the drape and flow of the embroidered lawn suit, phone still raised",
      "background": "Same mirror setting with soft diffused lighting, modern minimalist room with warm undertones",
      "motion": "gentle orbit right",
      ...
      "vo": "Dekho yeh embroidery kitni gorgeous hai, aur fabric ka drape - unreal"
    },
    {
      "n": 3,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Closer waist-up framing of the woman in mirror, focusing on intricate embroidery details and neckline, holding phone for selfie",
      "background": "Close-up mirror reflection with soft backlighting, blurred warm interior background",
      "motion": "slow zoom in",
      "energy": "shimmer highlights",
      "transitionIn": "whip",
      "durationSec": 6.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "Is embroidered work ko dekho - premium quality hai bilkul"
    },
    {
      "n": 4,
      "goal": "wear",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Woman looks confidently at camera through mirror while holding phone, showing complete styled look with dupatta",
      "background": "Full mirror view with elegant room setting, soft window light creating dreamy atmosphere",
      "motion": "gentle tilt left",
      "energy": "confident glow",
      "transitionIn": "fade",
      "durationSec": 5.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "Perfect hai meri Eid ki shopping ke liye"
    },
    {
      "n": 5,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Final confident pose in mirror, woman smiling at camera while holding phone, complete outfit visible",
      "background": "Bright mirror setting with optimistic lighting, clean modern aesthetic",
      "motion": "slow pull back",
      "energy": "sparkle overlay",
      "transitionIn": "cut",
      "durationSec": 8.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "Tumko bhi chahiye? The Collection se shop karo abhi - link description mein hai"
    }
  ],
  "badges": [],
  "notes": "Mirror selfie format captures authentic social media aesthetic while showcasing the premium embroidered lawn suit. Each scene builds confidence and desire through personal testimonial style voiceover in natural Hinglish, ending with clear shopping direction."
}
```
...
```json
{
  ...
  "seed": 8164,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: Large wall mirror in tastefully styled modern bedroom, soft natural light streaming from window, warm neutral tones, blurred elegant decor. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": true
}
...
```json
{
  ...
  "full_prompt_sent": "slow push-in. Full-length mirror shot of confident woman holding phone up, wearing complete embroidered green lawn suit, head-to-toe view in modern room. golden hour glow.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_1.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.15,
...
```json
{
  "vo_text": "Guys, main bilkul obsessed hun is outfit ke saath",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8165,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Same woman turns to flattering three-quarter angle in mirror, showing the drape and flow of the embroidered lawn suit, phone still raised. Setting: Same mirror setting with soft diffused lighting, modern minimalist room with warm undertones. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
    "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/product_1.jpg"
  ],
  "shows_person": true
}
```
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "gentle orbit right",
  "energy_prompt_verbatim": "fabric flutter",
  "full_prompt_sent": "gentle orbit right. Same woman turns to flattering three-quarter angle in mirror, showing the drape and flow of the embroidered lawn suit, phone still raised. fabric flutter.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_2.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.12,
...
```json
{
  "vo_text": "Dekho yeh embroidery kitni gorgeous hai, aur fabric ka drape - unreal",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/audio/scene_2.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8166,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Closer waist-up framing of the woman in mirror, focusing on intricate embroidery details and neckline, holding phone for selfie. Setting: Close-up mirror reflection with soft backlighting, blurred warm interior background. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "slow zoom in",
  "energy_prompt_verbatim": "shimmer highlights",
  "full_prompt_sent": "slow zoom in. Closer waist-up framing of the woman in mirror, focusing on intricate embroidery details and neckline, holding phone for selfie. shimmer highlights.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_3.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/clip_3.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.18,
...
```json
{
  "vo_text": "Is embroidered work ko dekho - premium quality hai bilkul",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/audio/scene_3.mp3",
  "measured_duration": 6.0,
  "planned_duration": 6.0
}
```
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8167,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Woman looks confidently at camera through mirror while holding phone, showing complete styled look with dupatta. Setting: Full mirror view with elegant room setting, soft window light creating dreamy atmosphere. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "gentle tilt left",
  "energy_prompt_verbatim": "confident glow",
  "full_prompt_sent": "gentle tilt left. Woman looks confidently at camera through mirror while holding phone, showing complete styled look with dupatta. confident glow.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_4.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/clip_4.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.12,
...
```json
{
  "vo_text": "Perfect hai meri Eid ki shopping ke liye",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/audio/scene_4.mp3",
  "measured_duration": 5.0,
  "planned_duration": 5.0
}
```
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 8168,
  "positive_prompt": "Keep the SAME person and the SAME outfit exactly as in this photograph - identical face, hair, skin tone and clothing. Re-frame them for this new shot: Final confident pose in mirror, woman smiling at camera while holding phone, complete outfit visible. Setting: Bright mirror setting with optimistic lighting, clean modern aesthetic. The model WEARS the complete outfit, with any dupatta or scarf draped naturally on the body. Show ONLY the person wearing it - absolutely no clothing rack, coat stand, hanger, mannequin or separately-displayed garment anywhere in the frame. CRITICAL: every garment piece keeps its OWN exact colour from the reference - never recolour, tint or harmonise one piece to match another (e.g. if the trousers are black and the dupatta is purple, the trousers stay black and the dupatta stays purple). STRICT: the person must be fully and MODESTLY dressed at all times - absolutely no nudity, no cleavage, no bare shoulders, midriff or legs, and no revealing, tight, sheer or sexy clothing. Keep it decent, elegant and family-friendly. The outfit MUST be an EXACT replica of the one in the reference photo - identical colour on every piece, identical embroidery or print pattern, motif placement, borders, neckline, sleeves, hem and fabric texture. Do NOT redesign, restyle, simplify, recolour, add or remove ANY detail - only the pose, angle or framing may change. Do not invent an unseen back or print. She is taking a mirror selfie and keeps her phone raised in one hand in this shot too - never empty-handed. The presenter faces the camera directly with a clear, well-lit, UNOBSTRUCTED front view of the whole face (both eyes and the mouth fully visible) - the product must not cover the face - a natural, confident expression ready to speak to the viewer. Use the SAME person as in the FIRST reference image - identical face, hair, skin tone and body - only the pose, angle or framing changes. ABSOLUTE REQUIREMENT - override any other wording: the person wears a high-necked, fully-covering outfit that completely covers the chest, cleavage, shoulders, midriff and legs. NO exposed skin below the collarbone, NO cleavage, NO revealing, low-cut, plunging, strapless, off-shoulder or sheer clothing. If a necklace is worn it rests on a COVERED high neckline. Decent, elegant, family-friendly ONLY. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_1.png",
  "anchor_used": true,
  "extra_refs": [
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "slow pull back",
  "energy_prompt_verbatim": "sparkle overlay",
  "full_prompt_sent": "slow pull back. Final confident pose in mirror, woman smiling at camera while holding phone, complete outfit visible. sparkle overlay.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/scene_5.png",
  "requested_duration": 8.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/clip_5.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.15,
    "end": 1.0,
...
```json
{
  "vo_text": "Tumko bhi chahiye? The Collection se shop karo abhi - link description mein hai",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/audio/scene_5.mp3",
  "measured_duration": 8.0,
...
```json
{
  ...
  "total_duration": 29.83,
  "master_resolution": "1080x1920",
  "captions_burned": false,
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_9c6928e8/reel_9c6928e8_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_9c6928e8_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_9c6928e8_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_9c6928e8_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_9c6928e8_s3.png",
    "https://staging-storage.runkarobar.com/images/reel_9c6928e8_s4.png",
    "https://staging-storage.runkarobar.com/images/reel_9c6928e8_s5.png"
  ],
  "log": "NOT PERSISTED"
}
```
