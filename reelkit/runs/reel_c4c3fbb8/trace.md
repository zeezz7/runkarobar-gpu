# Reel run trace — `reel_c4c3fbb8`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_c4c3fbb8`
...
```json
{
  "concept": "Elegant embroidered luxury meets modern sophistication",
  "voice": "female warm aspirational Hinglish",
  "scenes": [
    {
      "n": 1,
      "goal": "reveal",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Woman in embroidered green lawn suit standing confidently on urban street",
      "background": "elegant city street with classic architecture, warm golden hour light streaming from behind, soft bokeh of building facades",
      "motion": "slow push-in",
      ...
      "vo": "Jab style aur elegance ka perfect blend chahiye toh The Collection hai na"
    },
    {
      "n": 2,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Close-up of intricate embroidered neckline and sleeve details",
      "background": "soft neutral marble surface with delicate rim lighting, luxurious cream backdrop with subtle texture",
      "motion": "gentle orbit",
      "energy": "",
      "transitionIn": "cut",
      "durationSec": 4.0,
      ...
      "vo": "Dekho kitni beautiful embroidery hai, har thread mein luxury"
    },
    {
      "n": 3,
      "goal": "wear",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Full outfit showcase with dupatta flowing gracefully",
      "background": "premium boutique setting with soft ambient lighting, polished surfaces reflecting warm glow",
      "motion": "crane down",
      ...
      "vo": "Lawn ki comfort aur premium embroidery ka combination - bilkul perfect"
    },
    {
      "n": 4,
      "goal": "lifestyle",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Confident stride showing complete ensemble in natural movement",
      "background": "upscale urban environment with contemporary architecture, natural daylight with sophisticated shadows",
      "motion": "tracking shot",
      "energy": "confidence aura",
      "transitionIn": "zoom",
      "durationSec": 4.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "Har occasion ke liye ready ho jao sophisticated look ke saath"
    },
    {
      "n": 5,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Final glamorous pose with brand focus and confident smile",
      "background": "luxurious display setting with premium lighting setup, elegant backdrop with subtle brand elements",
      "motion": "slow zoom",
      "energy": "sparkle highlight",
      "transitionIn": "fade",
      "durationSec": 2.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "The Collection - premium lawn suits"
    }
  ],
  "badges": [
    {
  ...
  "notes": "Aspirational storytelling showcasing the luxury embroidered lawn suit through elegant reveals, detail shots, and confident lifestyle moments. Warm Hinglish voiceover creates emotional connection while highlighting the premium craftsmanship and versatile elegance of The Collection brand."
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": false
}
...
```json
{
  ...
  "energy_prompt_verbatim": "golden light rays",
  "full_prompt_sent": "slow push-in. Woman in embroidered green lawn suit standing confidently on urban street. golden light rays.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/scene_1.png",
  "requested_duration": 4.612,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.15,
...
```json
{
  "vo_text": "Jab style aur elegance ka perfect blend chahiye toh The Collection hai na",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7867,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: soft neutral marble surface with delicate rim lighting, luxurious cream backdrop with subtle texture. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "full_prompt_sent": "gentle orbit. Close-up of intricate embroidered neckline and sleeve details.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/scene_2.png",
  "requested_duration": 4.691,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.2,
...
```json
{
  "vo_text": "Dekho kitni beautiful embroidery hai, har thread mein luxury",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/audio/scene_2.mp3",
  "measured_duration": 4.691,
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7868,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: premium boutique setting with soft ambient lighting, polished surfaces reflecting warm glow. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "full_prompt_sent": "crane down. Full outfit showcase with dupatta flowing gracefully. fabric flutter.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/scene_3.png",
  "requested_duration": 5.736,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/clip_3.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.2,
    "end": 1.12,
...
```json
{
  "vo_text": "Lawn ki comfort aur premium embroidery ka combination - bilkul perfect",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/audio/scene_3.mp3",
  "measured_duration": 5.736,
  "planned_duration": 5.0
}
```

### Scene 4 — lifestyle / edit_animate / mode=product / engine=video
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7869,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: upscale urban environment with contemporary architecture, natural daylight with sophisticated shadows. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "tracking shot",
  "energy_prompt_verbatim": "confidence aura",
  "full_prompt_sent": "tracking shot. Confident stride showing complete ensemble in natural movement. confidence aura.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/scene_4.png",
  "requested_duration": 4.038,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/clip_4.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.12,
...
```json
{
  "vo_text": "Har occasion ke liye ready ho jao sophisticated look ke saath",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/audio/scene_4.mp3",
  "measured_duration": 4.038,
  "planned_duration": 4.0
}
```
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 7870,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: luxurious display setting with premium lighting setup, elegant backdrop with subtle brand elements. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  "engine": "wan",
  "path": "video_i2v",
  "motion_prompt_verbatim": "slow zoom",
  "energy_prompt_verbatim": "sparkle highlight",
  "full_prompt_sent": "slow zoom. Final glamorous pose with brand focus and confident smile. sparkle highlight.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/scene_5.png",
  "requested_duration": 2.941,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/clip_5.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.08,
...
```json
{
  "vo_text": "The Collection - premium lawn suits",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/audio/scene_5.mp3",
  "measured_duration": 2.941,
...
```json
{
  "per_scene": [
    ...
    {
      "scene": 2,
      "fitted_duration": 4.691,
      "transition_in": "cut",
      "dipped_through_black": false
    },
    {
      "scene": 3,
      "fitted_duration": 5.736,
      "transition_in": "whip",
      "dipped_through_black": true
    },
    {
      "scene": 4,
      "fitted_duration": 4.038,
      "transition_in": "zoom",
      "dipped_through_black": true
    },
    {
      "scene": 5,
      "fitted_duration": 2.941,
      "transition_in": "fade",
      "dipped_through_black": true
    }
  ],
  "transition_fallbacks": [
    ...
    "scene 4: 'zoom' not implemented -> fade"
  ],
  ...
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_c4c3fbb8/reel_c4c3fbb8_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_c4c3fbb8_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_c4c3fbb8_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_c4c3fbb8_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_c4c3fbb8_s3.png",
    "https://staging-storage.runkarobar.com/images/reel_c4c3fbb8_s4.png",
    "https://staging-storage.runkarobar.com/images/reel_c4c3fbb8_s5.png"
  ],
  "log": "NOT PERSISTED"
}
```
