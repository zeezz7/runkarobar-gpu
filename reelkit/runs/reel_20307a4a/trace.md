# Reel run trace — `reel_20307a4a`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_20307a4a`
...
```json
{
  ...
  "brief": "20s premium reel for this ruby necklace set, warm female Hinglish voiceover",
  "config": {
    "lengthSec": 20,
    "resolution": "1080p",
    "aspectRatio": "9:16",
...
```json
{
  "concept": "Premium ruby elegance that speaks without words",
  ...
  "scenes": [
    {
      ...
      "method": "edit_animate",
      "mode": "product",
      "visual": "Ruby necklace set elegantly displayed in an open palm, the deep red stones catching light against diamonds",
      "background": "soft cream marble surface with gentle natural light from above, warm golden hour glow, subtle shadows creating depth",
      "motion": "slow push-in",
      "energy": "",
      "transitionIn": "fade",
      "durationSec": 7.0,
      ...
      "vo": "Kuch cheezein sirf dikhti nahi, mehsoos hoti hain - ruby ki royal elegance"
    },
    {
      "n": 2,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Extreme close-up of the ruby pendant's center stone, showcasing the intricate diamond halo and craftsmanship details",
      "background": "soft focus velvet texture in deep charcoal, dramatic side lighting creating sparkle and depth",
      "motion": "gentle orbit",
      "energy": "subtle light rays",
      "transitionIn": "zoom",
      "durationSec": 6.0,
      "motionEngine": "video",
      "kenburns": {
      ...
      "vo": "Har ruby stone mein chhupa hai perfect craftsmanship"
    },
    {
      "n": 3,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Complete ruby necklace and earring set artfully arranged, showing the matching design elements and coordinated beauty",
      "background": "pristine white silk with soft diffused lighting, creating an airy luxury feel with minimal shadows",
      ...
      "vo": "Premium ruby collection - apna style statement banayiye"
    }
  ],
  "badges": [],
  "notes": "Premium showcase focusing on the inherent beauty of the ruby set. Clean, minimal approach letting the jewelry speak through elegant framing and subtle camera movement. Warm Hinglish VO emphasizes the emotional connection and craftsmanship without making unsupported claims."
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": false
}
...
```json
{
  ...
  "full_prompt_sent": "slow push-in. Ruby necklace set elegantly displayed in an open palm, the deep red stones catching light against diamonds.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/scene_1.png",
  "requested_duration": 7.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.0,
    "end": 1.15,
...
```json
{
  "vo_text": "Kuch cheezein sirf dikhti nahi, mehsoos hoti hain - ruby ki royal elegance",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 5765,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: soft focus velvet texture in deep charcoal, dramatic side lighting creating sparkle and depth. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "energy_prompt_verbatim": "subtle light rays",
  "full_prompt_sent": "gentle orbit. Extreme close-up of the ruby pendant's center stone, showcasing the intricate diamond halo and craftsmanship details. subtle light rays.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/scene_2.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.25,
...
```json
{
  "vo_text": "Har ruby stone mein chhupa hai perfect craftsmanship",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/audio/scene_2.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 5766,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: pristine white silk with soft diffused lighting, creating an airy luxury feel with minimal shadows. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "energy_prompt_verbatim": "",
  "full_prompt_sent": "slow pull-out. Complete ruby necklace and earring set artfully arranged, showing the matching design elements and coordinated beauty.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/scene_3.png",
  "requested_duration": 7.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/clip_3.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.2,
    "end": 1.12,
...
```json
{
  "vo_text": "Premium ruby collection - apna style statement banayiye",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/audio/scene_3.mp3",
  "measured_duration": 7.0,
  "planned_duration": 7.0
}
```
...
```json
{
  ...
  "total_duration": 19.86,
  "master_resolution": "1080x1920",
  "captions_burned": false,
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_20307a4a/reel_20307a4a_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_20307a4a_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_20307a4a_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_20307a4a_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_20307a4a_s3.png"
  ],
  "log": "NOT PERSISTED"
}
```
