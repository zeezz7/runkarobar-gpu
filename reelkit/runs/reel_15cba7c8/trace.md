# Reel run trace — `reel_15cba7c8`

Run directory: `/workspace/runkarobar-gpu/reelkit/runs/reel_15cba7c8`
...
```json
{
  "concept": "Exquisite embroidered luxury that makes every moment special",
  ...
  "scenes": [
    {
      ...
      "method": "edit_animate",
      "mode": "product",
      "visual": "Woman in elegant emerald green embroidered lawn suit with intricate silver threadwork, holding matching dupatta",
      "background": "soft marble surface with warm golden hour light filtering through, creating gentle shadows and highlights",
      "motion": "slow push-in",
      "energy": "",
      "transitionIn": "fade",
      "durationSec": 5.0,
      ...
      "vo": "Jab style meets elegance, toh kuch aisa hota hai"
    },
    {
      "n": 2,
      "goal": "detail",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Close-up of the intricate silver embroidery and threadwork details on the emerald fabric",
      "background": "rich textured silk surface with soft diffused lighting, creating depth and luxury feel",
      "motion": "gentle orbit",
      ...
      "vo": "Har thread mein hai craftsmanship ka jaadu"
    },
    {
      "n": 3,
      "goal": "cta",
      "method": "edit_animate",
      "mode": "product",
      "visual": "Full elegant portrait showcasing the complete embroidered lawn suit ensemble with dupatta",
      "background": "pristine white marble backdrop with soft natural lighting and subtle texture details",
      ...
      "vo": "The Collection - jahan har outfit ek masterpiece hai"
    }
  ],
  "badges": [],
  "notes": "Premium showcase focusing on the exquisite embroidery craftsmanship. Varied framing from lifestyle to detail to hero shot, with subtle camera moves and warm aspirational tone that celebrates the artisanal quality without hard selling."
}
```
...
```json
{
  ...
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
  "shows_person": false
}
...
```json
{
  ...
  "full_prompt_sent": "slow push-in. Woman in elegant emerald green embroidered lawn suit with intricate silver threadwork, holding matching dupatta.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/scene_1.png",
  "requested_duration": 5.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/clip_1.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.15,
...
```json
{
  "vo_text": "Jab style meets elegance, toh kuch aisa hota hai",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/audio/scene_1.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 874,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: rich textured silk surface with soft diffused lighting, creating depth and luxury feel. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "full_prompt_sent": "gentle orbit. Close-up of the intricate silver embroidery and threadwork details on the emerald fabric. subtle shimmer.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/scene_2.png",
  "requested_duration": 4.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/clip_2.mp4",
  "kenburns": {
    "zoom": "in",
    "start": 1.12,
    "end": 1.25,
...
```json
{
  "vo_text": "Har thread mein hai craftsmanship ka jaadu",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/audio/scene_2.mp3",
...
```json
{
  ...
  "fast_lightning_4step": true,
  "seed": 875,
  "positive_prompt": "Keep the subject exactly as photographed - same face, same garment, same colours, same fabric and the same printed branding, unchanged. Change only the surroundings to: pristine white marble backdrop with soft natural lighting and subtle texture details. The product itself MUST be the exact SAME item as the reference - identical design, colours, materials, shape AND all of its OWN printed branding: keep the real brand name, logo and label text exactly as they are and fully legible. Do NOT invent, restyle, swap or blank out any logo, emblem, label or text, and NEVER turn it into a generic unbranded version. You may re-angle, zoom, crop, re-light and place it into the new setting the scene describes - but the product and its branding stay faithful. Keep the product - INCLUDING its own printed brand name, logo and label - exactly as the reference and fully legible; do not add any new overlaid text, watermark or logo of your own, and do not blank or replace the product's real branding. Photorealistic editorial photograph, sharp detail.",
  "negative_prompt": "changed clothing, different garment, altered colours, warped fabric, distorted face, extra limbs, deformed hands, blurry, low quality, jpeg artifacts, watermark",
  "source_photo": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/product_1.jpg",
  "anchor_used": false,
  "extra_refs": [],
...
```json
{
  ...
  "energy_prompt_verbatim": "",
  "full_prompt_sent": "slow pull-back. Full elegant portrait showcasing the complete embroidered lawn suit ensemble with dupatta.",
  "input_still": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/scene_3.png",
  "requested_duration": 6.0,
  "clip_path": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/clip_3.mp4",
  "kenburns": {
    "zoom": "out",
    "start": 1.2,
    "end": 1.12,
...
```json
{
  "vo_text": "The Collection - jahan har outfit ek masterpiece hai",
  "voice_id": "RAPmAZHXSuTrzY9pjpR3",
  "model_id": "eleven_v3",
  "mp3_path": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/audio/scene_3.mp3",
...
```json
{
  ...
  "total_duration": 14.88,
  "master_resolution": "1080x1920",
  "captions_burned": false,
  "fps": 30,
  "outputs": {
    "1080p": "/workspace/runkarobar-gpu/reelkit/work/reel_15cba7c8/reel_15cba7c8_1080p.mp4"
  }
}
```
...
```json
{
  "reel_1080p_url": "https://staging-storage.runkarobar.com/reels/reel_15cba7c8_1080p.mp4",
  "reel_720p_url": "",
  "scene_image_urls": [
    "https://staging-storage.runkarobar.com/images/reel_15cba7c8_s1.png",
    "https://staging-storage.runkarobar.com/images/reel_15cba7c8_s2.png",
    "https://staging-storage.runkarobar.com/images/reel_15cba7c8_s3.png"
  ],
  "log": "NOT PERSISTED"
}
```
